<?php /* Smarty version Smarty-3.1.8, created on 2015-01-09 19:41:11
         compiled from "C:\xampp\htdocs\thegympark/presentation/templates\adminCategory.tpl" */ ?>
<?php /*%%SmartyHeaderCode:522854b07527da8184-53440313%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '298b290a66d83e44b79ab0964e643d52e8a01f5c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\thegympark/presentation/templates\\adminCategory.tpl',
      1 => 1411333708,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '522854b07527da8184-53440313',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54b07528052080_05444188',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54b07528052080_05444188')) {function content_54b07528052080_05444188($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_presentation_object')) include 'C:\\xampp\\htdocs\\thegympark/presentation/smarty_plugins\\function.load_presentation_object.php';
?><?php echo smarty_function_load_presentation_object(array('filename'=>"adminCategory",'assign'=>"obj"),$_smarty_tpl);?>
...
">&laquo;<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinks[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['title'];?>
	...
	<div class=category>
		<h1 class=program_title><i>category:</i> <?php echo $_smarty_tpl->tpl_vars['obj']->value->mCategoryInfo['title'];?>

		<span class=program_options>
			<?php if (!$_smarty_tpl->tpl_vars['obj']->value->mCategoryEdit){?>
				<form method=post>
						<input type=submit class="btn btn-default btn-primary" name="tgp_category_delete" value="Delete&raquo;"> <input type=submit class="btn btn-default btn-primary" name="tgp_category_edit" value="Edit&raquo;"> <input type=submit class="btn btn-default btn-primary" name=tgp_category_send_email value="Send Email&raquo;">
				</form>
			<?php }?>
		</span>
		</h1>
		...
		<?php if ($_smarty_tpl->tpl_vars['obj']->value->mCategoryEdit){?>
			<form method=post>
			<input type=hidden name=tgp_category_id value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mCategoryInfo['cc_id'];?>
">
			<p>
				<label>Program</label><br/>
				<select name=tgp_category_program_id>
...
?>
					<option 
					<?php if ($_smarty_tpl->tpl_vars['obj']->value->mPrograms[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['program_id']==$_smarty_tpl->tpl_vars['obj']->value->mCategoryInfo['program_id']){?>
						selected 
					<?php }?>
					value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mPrograms[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['program_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['obj']->value->mPrograms[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['title'];?>
			...
			<p>
				...
				<input type=text name=tgp_category_title value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mCategoryInfo['title'];?>
">
			</p>
			<p>
				<label>Description</label><br/>
				<textarea name=tgp_category_description><?php echo $_smarty_tpl->tpl_vars['obj']->value->mCategoryInfo['description'];?>
</textarea>
			</p>

			<p>
				To pick a color for this category choose from below by clicking on the color you want.
			</p>
			<!--
				Color Picking starts here
			//-->
		<script>
		<!--
		var colorhex = "<?php echo $_smarty_tpl->tpl_vars['obj']->value->mCategoryInfo['hexColor'];?>
";
		...
		{
			var hexColor = document.getElementById( 'colorhex' );
		...
		<div id='selectedColor' style="visibility:hidden;position:relative;width:21px;height:21px;background-image:url( '<?php echo Link::Build('images/selectedcolor.gif');?>
');">
		</div>
		<img style='margin-right:2px;' src='<?php echo Link::Build('images/colormap.gif');?>
' usemap='#colormap' alt='colormap' />
		<map id='colormap' name='colormap' onmouseout='mouseOutMap();'>
			...
			<area style='cursor:pointer' shape='poly' coords='117,180,126,184,126,195,117,199,108,195,108,184' onclick='clickColor("#993300",200,108)' onmouseover='mouseOverColor("#993300")' alt='#993300' /><area style='cursor:pointer' shape='poly' coords='135,180,144,184,144,195,135,199,126,195,126,184' onclick='clickColor("#990000",200,126)' onmouseover='mouseOverColor("#990000")' alt='#990000' />
			<area style='cursor:pointer' shape='poly' coords='153,180,162,184,162,195,153,199,144,195,144,184' onclick='clickColor("#800000",200,144)' onmouseover='mouseOverColor("#800000")' alt='#800000' /><area style='cursor:pointer' shape='poly' coords='171,180,180,184,180,195,171,199,162,195,162,184' onclick='clickColor("#993333",200,162)' onmouseover='mouseOverColor("#993333")' alt='#993333' />
		</map>	
			<div style='width:200px;padding-top:33px;padding-left:66px;margin-bottom:30px;'>
				<div id='divpreview' style='float:left;height:30px;width:100px;border:1px solid #d4d4d4;border-bottom:none;background-color:<?php echo $_smarty_tpl->tpl_vars['obj']->value->mCategoryInfo['hexColor'];?>
'>
					&nbsp;
				</div>
				<div id='divpreviewtxt' style='float:left;width:50px;padding-left:5px;padding-top:7px;'><?php echo $_smarty_tpl->tpl_vars['obj']->value->mCategoryInfo['hexColor'];?>
</div>
			</div>

			<!--
				End of color picking addition
			//-->		
				
				<p>
					<label>Hex Color</label><br/>
					<input type=text id=colorhex name=tgp_category_color value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mCategoryInfo['hexColor'];?>
">
				</p>
				<p>
					<input type=submit name=tgp_category_save value="Save Changes &raquo;">
				</p>
				</form>
			<?php }else{ ?>
				<p><b>Description:</b></p>
		...
		<div class=class_groups>
			<h3 class=program_title>
				Class Titles
			<span class=program_options>
					<a href="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinkToAddClassTitle;?>
">+Add Class Title&raquo;</a>
			</span>
			</h3>
...
?>
				<p style="padding:5px;">
					<a href="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mClassTitles[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['link_class_title'];?>
"><?php echo $_smarty_tpl->tpl_vars['obj']->value->mClassTitles[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['title'];?>
 <?php echo $_smarty_tpl->tpl_vars['obj']->value->mClassTitles[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['age_group'];?>
</a> 
					<span style="float:right;"><a href="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mClassTitles[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['link_to_add_class'];?>
