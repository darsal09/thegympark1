<?php /* Smarty version Smarty-3.1.8, created on 2015-01-18 12:54:01
         compiled from "C:\xampp\htdocs\thegympark/presentation/templates\addCategory.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1509254bbf3395434d3-03798860%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd5f13e93d9aafb54363e4c5e86a74e88811e8f08' => 
    array (
      0 => 'C:\\xampp\\htdocs\\thegympark/presentation/templates\\addCategory.tpl',
      1 => 1411526417,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1509254bbf3395434d3-03798860',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54bbf339687857_79475645',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54bbf339687857_79475645')) {function content_54bbf339687857_79475645($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_presentation_object')) include 'C:\\xampp\\htdocs\\thegympark/presentation/smarty_plugins\\function.load_presentation_object.php';
?><?php echo smarty_function_load_presentation_object(array('filename'=>"addCategory",'assign'=>"obj"),$_smarty_tpl);?>
...
">&laquo;Admin</a></li>
		<li><a href="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinkToProgram;?>
">&laquo;Program</a></li>
	</ol>
<div class=row>	
	<div class=col-md-6>
		<h1 class=program_title>Add Category</h1>
		...
		<form method=post role=form>
			<div class="form-group <?php if ($_smarty_tpl->tpl_vars['obj']->value->mErrors[':title']){?>has-error<?php }?>">
				...
				<input type=text class=form-control name=tgp_category_title value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mP[':title'];?>
">
			</div>
			
			<div class="form-group <?php if ($_smarty_tpl->tpl_vars['obj']->value->mErrors[':desc']){?>has-error<?php }?>">
				<label class=control-label>Description</label><br/>
				<textarea class=form-control name=tgp_category_description><?php echo $_smarty_tpl->tpl_vars['obj']->value->mP[':desc'];?>
</textarea>
			</div>
			...
			<div id='selectedColor' style='visibility:hidden;position:relative;width:21px;height:21px;background-image:url("../images/selectedcolor.gif")'>
			</div>
			<img style='margin-right:2px;' src='../images/colormap.gif' usemap='#colormap' alt='colormap' />
			...
			<div style='width:200px;padding-top:33px;padding-left:66px;margin-bottom:30px;'>
				<div id='divpreview' style='float:left;height:30px;width:100px;border:1px solid #d4d4d4;border-bottom:none;background-color:#FF0000'>
					&nbsp;
					
				</div>
				<div id='divpreviewtxt' style='float:left;width:50px;padding-left:5px;padding-top:7px;'>#FF0000</div>
			</div>
		...
		//-->
			<div class=clear></div>
			<div class="form-group <?php if ($_smarty_tpl->tpl_vars['obj']->value->mErrors[':color']){?>has-error<?php }?>">
				<label class=control-label>Color provide a hex number:</label>
				<input type=text class="form-control" id=colorhex name=tgp_category_color value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mP[':color'];?>
">			
			</div>
		
			<p>
				<input type=submit class="btn btn-default btn-primary btn-lg" name=tgp_category_addCategory value="Save Category">
			</p>		
		</form>
	</div>
</div><?php }} ?>