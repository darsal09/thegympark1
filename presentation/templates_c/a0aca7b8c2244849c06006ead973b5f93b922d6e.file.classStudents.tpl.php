<?php /* Smarty version Smarty-3.1.8, created on 2015-02-26 20:10:34
         compiled from "C:\xampp\htdocs\thegympark/presentation/templates\admin\classStudents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1235354bc011ad9c058-03944835%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a0aca7b8c2244849c06006ead973b5f93b922d6e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\thegympark/presentation/templates\\admin\\classStudents.tpl',
      1 => 1424649555,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1235354bc011ad9c058-03944835',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_54bc011adfdad1_00375127',
  'variables' => 
  array (
    'obj' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_54bc011adfdad1_00375127')) {function content_54bc011adfdad1_00375127($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_presentation_object')) include 'C:\\xampp\\htdocs\\thegympark/presentation/smarty_plugins\\function.load_presentation_object.php';
?><?php echo smarty_function_load_presentation_object(array('filename'=>"classStudents",'foldername'=>"admin",'assign'=>"obj"),$_smarty_tpl);?>

	<h3>
		Students
		<span class=pull-right>
			<a class="btn btn-default btn-warning classAttendance"  href="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinkToTakeAttendance;?>
">Take Attendance&raquo;</a> 
			<a class="btn btn-default btn-primary addStudent" href="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinkToAddExistingParticipant;?>
">Add Existing Participant&raquo;</a> 
			<a class="btn btn-default btn-primary" href="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinkToAddChild;?>
...
.</td>
				<td>
					<a class=students href="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['link_to_student'];?>
"><span id="name_<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
...
, <?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['first'];?>
				...
				<td>
					<?php echo date('m/d/Y',strtotime($_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['start']));?>

				</td>
				<td>
					<?php echo date('m/d/Y',strtotime($_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['end']));?>
				
				</td>
				<td>
					$<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['price'];?>

				</td>
				<td>
					<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['status'];?>

				</td>
				<td>
					<span class=pull-right>
						<?php if ($_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['status']=='Pending'){?>
							<a class="btn btn-default btn-primary payment" id="payment_<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
" href="">Take Payment&raquo;</a>
						<?php }?>
						<a class="btn btn-default btn-primary edit" id="edit_<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
" href="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['link_to_edit'];?>
">edit&raquo;</a>
						<a class="btn btn-default btn-success" href="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['link_to_student'];?>
">view&raquo;</a>
						<a class="btn btn-default btn-danger remove" id="remove_<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
" href="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['link_to_remove'];?>
">remove&raquo;</a>
					</span>
				</td>
			</tr>
						...
						<div class=modal-content>
							<form id=classAttendance>
								<div class=form-group>
									...
									<input type=text id=attendance_date name=date value="<?php echo date('m/d/Y');?>
">
...
?>
										<div class="row form-group">
											<div class=col-md-6>
												<label><?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['first'];?>
 <?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['last'];?>
</label>
											</div>
											<div class=col-md-6>
												<input type=checkbox name=attendance[] value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
">
											</div>
										</div>
									<?php endfor; endif; ?>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class=modal-content style="padding:5px;">
							<input type=hidden id=full_start_date value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mFull['begin'];?>
">
							<input type=hidden id=full_end_date value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mFull['end'];?>
">
							<input type=hidden id=first_start_date value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mFirst['begin'];?>
">
							<input type=hidden id=first_end_date value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mFirst['end'];?>
">
							<input type=hidden id=last_start_date value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLast['begin'];?>
">
							<input type=hidden id=last_end_date value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLast['end'];?>
">
							<input type=hidden id=price value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mClass['price'];?>
">
							<input type=hidden id=9WeekPrice value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mClass['9WeekPrice'];?>
">
...
$( document ).ready( function()
{
	...
	*/
	$( '.save' ).click( function( e )
	{
		...
		$.post( '<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinkToTakePayment;?>
',
	...
	*/
	...
	{		
		e.preventDefault();
		$.post( "<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinkForAttendance;?>
",
	...
	*/
	...
	function getStudents()
	{
		...
		var lastName 	= $( '#lastName' ).val();
			...
			$.get( "<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinkToGetStudents;?>
",
			{
...
,
	...
	*/
	$( '.register' ).click(function( e ){
		...
		$.post( "<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinkToAddStudents;?>
",
...
//				$( '#studentsTable' ).append( '<tr><td></td><td>'+data.info.name+'</td><td>'+data.info.age+'</td><td>'+data.info.start+'</td><td>'+data.info.end+'</td><td>'+data.info.price+'</td><td>'+data.info.status+'</td><td><a href="">Edit&raquo;</a> <a href="">View&raquo;</a> <a href="">Remove&raquo;</a></td></tr>' );
	...
	*/
	...
	$( '.update' ).click( function( e )
	{
		...
		$.post( "<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinkToUpdateStudents;?>
",
	...
	*/
	$( '.remove' ).click( function( e )
	{
		...
		{
			$.post("<?php echo $_smarty_tpl->tpl_vars['obj']->value->mLinkToRemoveStudents;?>
",
				{
					classID:<?php echo $_smarty_tpl->tpl_vars['obj']->value->mClassID;?>
,
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['i']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['i']['total']);
?>
	students[ <?php echo $_smarty_tpl->getVariable('smarty')->value['section']['i']['index'];?>
 ] = new Student( '<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['first'];?>
 <?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['last'];?>
', '<?php echo date("m/d/Y",strtotime($_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['start']));?>
', '<?php echo date("m/d/Y",strtotime($_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['end']));?>
', <?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
, <?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['price'];?>
, '<?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['classType'];?>
', <?php echo $_smarty_tpl->tpl_vars['obj']->value->mStudents[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['classStudentID'];?>
 )
<?php endfor; endif; ?>
