<?php
class openPlayRegistrationStep3
{
	...
	public function __construct()
	{
		...
		if( isset( $_POST[ 'tgp_openplay_registration_step3' ] ) )
			$this->save();
	}
	...
	private function save()
	{
		...
		header( 'Location:'.Link::Build( 'openplay-'.$this->mOpenPlayID.'/register/package-'.$this->mPackageID.'/final' ) );
		exit;
	}
