...
class addOpenPlayClass
{
	...
	private $_mRequired = array( ':tID' => true, ':year' => true, ':sTime' => true, ':eTime' => true, ':wDay' => true, ':sDate' => true, ':eDate' => true, ':sID' => true, ':cID' => true, ':pID' => true, ':Price' => false , ':pFeatured' => true, ':cFeatured' => true, ':Type' => true );
	...
	private function saveClass()
	{
		...
		$ct = catalog::getClassGroup( $this->mOpenPlayID );	
		print_r( $ct );	
