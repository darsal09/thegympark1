...
{	
	...
	{						
		...
		if( $this->mClassTitle[ 'type' ] == "Flexible" )
		{
			...
			helper::redirect( 'admin/open-plays/'.$op[ 'id' ] );
		}
		
		$this->mClassesSchedule 			= classGroupModel::getCurrentClasses( array( ':cgID' => $this->mClassGroupID ) );	
		...
		$this->mLinkToCategory 	= Link::Build( 'amdin/programs/'.$this->mProgramID.'/categories/'.$this->mCategoryID );	
		$this->mLinkToAddClass	= Link::Build( 'admin/programs/'.$this->mProgramID.'/categories/'.$this->mCategoryID.'/class-groups/'.$this->mClassGroupID.'/addClass' );
	}
	...
	private function setTimeFormat()
	{
		...
		{			
			...
			$this->mClassesSchedule[ $i ][ 'link_to_class' ] = Link::Build( 'admin/programs/'.$this->mProgramID.'/categories/'.$this->mCategoryID.'/class-groups/'.$this->mClassGroupID.'/classes/'.$this->mClassesSchedule[ $i ][ 'class_id' ] );
		}
	}
