{load_presentation_object filename="addCategory" assign="obj"}
	<!--
...
//-->
	...
	<ol class=breadcrumb>
		...
		<li><a href="{$obj->mLinkToProgram}">&laquo;Program</a></li>
	</ol>
<div class=row>	
	<div class=col-md-6>
		...
		<form method=post role=form>
			<div class="form-group {if $obj->mErrors[ ':title' ]}has-error{/if}">
				...
				<input type=text class=form-control name=tgp_category_title value="{$obj->mP[  ':title' ]}">
			</div>
			
			<div class="form-group {if $obj->mErrors[ ':desc' ]}has-error{/if}">
				<label class=control-label>Description</label><br/>
				<textarea class=form-control name=tgp_category_description>{$obj->mP[ ':desc' ]}</textarea>
			</div>
		...
		//-->
			<div class=clear></div>
			<div class="form-group {if $obj->mErrors[ ':color' ]}has-error{/if}">
				<label class=control-label>Color provide a hex number:</label>
				<input type=text class="form-control" id=colorhex name=tgp_category_color value="{$obj->mP[ ':color' ]}">			
			</div>
