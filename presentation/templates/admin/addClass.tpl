{load_presentation_object filename="addClass" foldername="admin" assign="obj"}	
<ol class=breadcrumb>
		<li><a href="{$obj->mLinkToProgram}">&laquo;{$obj->mProgramTitle}</a></li>
		<li><a href="{$obj->mLinkToCategory}">&laquo;{$obj->mCategoryTitle}</a></li>
		<li><a href="{$obj->mLinkToClassGroup}">&laquo;{$obj->mClassTitle.title} {$obj->mClassTitle.age_group}</a></li>
</ol>
