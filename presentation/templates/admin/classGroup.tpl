{load_presentation_object filename="classGroup" foldername=admin assign="obj"}
<div class=page-header>
	<h1>
		{$obj->mClassTitle.title}<br/><small>For <span>{$obj->mClassTitle.age_group}</span></small>
		<small class=pull-right>
			<a class="btn btn-default btn-primary btn-lg" href="{$obj->mLinkToAddClass}">+Add Class&raquo;</a>
		</small>
		</h1>
</div>
