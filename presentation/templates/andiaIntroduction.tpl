      <!-- Slider -->
                ...
                <div class="row">
                    <div class="span10 offset1">
                        <div class="flexslider">
                            <ul class="slides">
                                <li data-thumb="http://localhost/thegympark/images/andia/slider/DSC09476.jpg">
                                    <a href="index.php?action=andiaWeekly"><img src="http://localhost/thegympark/images/andia/slider/DSC09476.jpg"></a>
                                ...
                                <li data-thumb="http://localhost/thegympark/images/andia/slider/2.jpg">
                                    <img src="http://localhost/thegympark/images/andia/slider/2.jpg">
                                ...
                                <li data-thumb="http://localhost/thegympark/images/andia/slider/DSC09476.jpg">
                                    <img src="http://localhost/thegympark/images/andia/slider/DSC09476.jpg">
                                    <p class="flex-caption">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et. Lorem ipsum dolor sit amet, consectetur.</p>
                                </li>
                                <li data-thumb="http://localhost/thegympark/images/andia/slider/6.jpg">
                                    <img src="http://localhost/thegympark/images/andia/slider/6.jpg">
                                    <p class="flex-caption">Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="presentation container">
            <h2><span class="violet">The Gym Park</span>, gymnastics inspired by play.</h2>
            <p>We aim to promote & teach positive social interaction and physical fitness for all ages through gymnastics.  </p>
        </div>
        ...
        <div class="what-we-do container">
            <div class="row">
                <div class="service span3">
                    ...
                    <a href="index.php?action=andiaWeekly">Read more&raquo;</a>
                </div>
                <div class="service span3">
                    <div class="icon-awesome">
        ...
        <div class="portfolio container">
            ...
            <div class="row">
                <div class="work span3">
                    <img src="images/andia/portfolio/work1.jpg" alt="">
                    <h4>Lorem Website</h4>
                ...
                <div class="work span3">
                    <img src="images/andia/portfolio/work2.jpg" alt="">
                    <h4>Ipsum Logo</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor...</p>
                    <div class="icon-awesome">
                ...
                <div class="work span3">
                    <img src="images/andia/portfolio/work3.jpg" alt="">
                    <h4>Dolor Prints</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor...</p>
                    <div class="icon-awesome">
                ...
                <div class="work span3">
                    <img src="images/andia/portfolio/work4.jpg" alt="">
                    ...
                    <div class="tabbable tabs-below">
                        <div class="tab-content">
                            <div class="tab-pane active" id="A">
                                <img src="http://localhost/thegympark/images/andia/testimonials/1.jpg" title="" alt="">
                            ...
                            <div class="tab-pane" id="B">
                                <img src="http://localhost/thegympark/images/andia/testimonials/2.jpg" title="" alt="">
                            ...
                            <div class="tab-pane" id="C">
                                <img src="http://localhost/thegympark/images/andia/testimonials/3.jpg" title="" alt="">
                                <p>"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et. Lorem ipsum dolor sit amet, consectetur..."<br /><span class="violet">Lorem Ipsum, dolor.co.uk</span></p>
                            </div>
