...
class classSignChildStep2
{
	...
	public $mP 		= array( 'first_name' => '', 'last_name' => '', 'dob' => '', 'gender' => '', 'parent1_name' => '', 'parent1_cell_phone' => '', 'parent1_work_phone' => '', 'parent1_email' => '', 'parent2_name' => '', 'parent2_cell_phone' => '', 'parent2_work_phone' => '', 'parent2_email' => '', 'street' => '', 'street1' => '', 'city' => '', 'state' => '', 'zip' => '', 'emergency_relation' => '', 'emergency_name' => '', 'emergency_phone' => '' );
	public $mReq 	= array( 'first_name' => true, 'last_name' => true, 'dob' => true, 'gender' => true, 'parent1_name' => true, 'parent1_fields' => array( 'parent1_cell_phone', 'parent1_work_phone', 'parent1_email' ), 'parent2_name' => true, 'parent2_fields' => array( 'parent2_cell_phone', 'parent2_work_phone', 'parent2_email' ),  'street' => true, 'street1' => false, 'city' => true, 'state' => true, 'zip' => true, 'emergency_relation' => true, 'emergency_name' => true, 'emergency_phone' => true );
	...
	public function __construct()
	{
		...
		if( isset( $_POST[ 'class_sign_up_child_step2' ] ) )
			$this->saveStep2();			
	}
	...
	private function saveStep2()
	{
		...
		header( 'Location:'.Link::Build( 'index.php?action=classSignChildStep3' ) );
		exit;
	}
